...
- 一键安装
  ...
  > ERROR: the directory /home/omm/software/openGauss/core/data/single_node must be dir and empty
  > ```
  >
  > 根据提示，关掉端口占用pid
  >
...
> export PATH
> export GAUSSHOME=/home/omm/software/openGauss/core
...
Environment=PGDATA=/home/omm/software/openGauss/core/data
Environment=GAUSSHOME=/home/omm/software/openGauss/core
Environment=LD_LIBRARY_PATH=/home/omm/software/openGauss/core/lib

ExecStart=/home/omm/software/openGauss/core/bin/gs_ctl start -D /home/omm/software/openGauss/core/data/single_node 
 
ExecReload=/home/omm/software/openGauss/core/bin/gs_ctl restart -D /home/omm/software/openGauss/core/data/single_node
 
ExecStop=/home/omm/software/openGauss/core/bin/gs_ctl stop -D /home/omm/software/openGauss/core/data/single_node
