...
![image-20211007205315484](https://gitee.com/wangigor/typora-images/raw/master/image-20211007205315484.png)

如果把集群唯一对象改为进程唯一对象，多个对象操作同一块数据区也是可以的。

而目前大多数分布式单例也是这么做的。如下。

![image-20211007205532827](https://gitee.com/wangigor/typora-images/raw/master/image-20211007205532827.png)
